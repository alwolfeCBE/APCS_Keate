...
public class MadLibsClient {
    public static void main(String[] args)
    {
        ...
        /*ToDo*/
        {
            /*Please prompt the user for values to save and use to set the instance variables. Save the user's responses. */
            /* TODO */
            //Create a new MadLibs story object with the values saved above.
            /*ToDo*/
